...
class TrainConfig():
    def __init__(self):
        self.config = {
            ...
            "gpu_id": GPU_ID,
            "weights": None,
            # "weights": os.path.join(BASE_DIR, "/hdd0/projects/regex/logs/unet_encoder_4attn_marginals/20210513_15:39:29/unet_encoder_4attn_marginals__best__epoch=009_score=0.9632.pt"),
            "freeze_backbone": False,
            "prefetch_data": False,
            "num_classes": 2,
            "subsample_frac": 1.0,
            ...
            # "loss_weights": True,
            "name": "unet_encoder_baseline_ensemble",
            "group": "baseline_ensemble",
